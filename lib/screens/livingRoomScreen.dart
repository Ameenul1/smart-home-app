...
class _LivingRoomScreenState extends State<LivingRoomScreen> {
  ...
  Future<void> getDevices() async{
    try{
      devices = await Device.getDeviceStatusByRoom("living_room");
      isError = false;
    }
    catch (e){
      isError = true;
    ...
    return FutureBuilder(
        ...
        (isError)?Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0,
            title: Text("Living Room",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black)),
          ),
          body: Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context,idx) => Padding(
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            leading: FaIcon(FontAwesomeIcons.bolt,color: Colors.red,),
                            title: Padding(
